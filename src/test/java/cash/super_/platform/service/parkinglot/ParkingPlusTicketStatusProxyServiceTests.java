...
import cash.super_.platform.service.parkinglot.ticket.ParkingPlusTicketPaymentsProxyService;
...
@SpringBootTest(properties = {"cash.super.platform.service.parkinglot.prop=false"})
